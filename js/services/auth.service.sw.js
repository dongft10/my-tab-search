 ...
 * popup 等页面请使用 auth.service.esm.js
 */

const _asFileGlobal = typeof self !== 'undefined' ? self : {};

if (typeof _asFileGlobal._authServiceInitialized === 'undefined') {
  _asFileGlobal._authServiceInitialized = true;

  var authApi = _asFileGlobal.authApi || null;
  ...
  _asFileGlobal.authService = new AuthService();
  _asFileGlobal.AuthService = AuthService;
}
