...
// 挂载到全局对象（Service Worker）
const _cfgSwGlobal = typeof self !== 'undefined' ? self : {};
_cfgSwGlobal.API_CONFIG = API_CONFIG;
_cfgSwGlobal.PINNED_TABS_CONFIG = PINNED_TABS_CONFIG;
_cfgSwGlobal.SEARCH_CONFIG = SEARCH_CONFIG;
_cfgSwGlobal.UI_CONFIG = UI_CONFIG;
_cfgSwGlobal.STORAGE_KEYS = STORAGE_KEYS;
_cfgSwGlobal.ENV_CONFIG = ENV_CONFIG;
_cfgSwGlobal.ENV_TYPE = ENV_TYPE;
_cfgSwGlobal.getApiUrl = getApiUrl;
_cfgSwGlobal.getCacheTime = getCacheTime;
